...
from models.baselines import available_baselines


def parse_args():
    parser = argparse.ArgumentParser(description="Train a baseline classifier.")
    parser.add_argument(
        "--model",
        required=True,
...
def build_config(args):
    ...
    cfg.experiment_name = args.experiment_name or f"baseline_{args.model}"
    cfg.refresh_paths()
    return cfg
